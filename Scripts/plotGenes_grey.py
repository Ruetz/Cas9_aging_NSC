...
for gene, ref, effect in ref_list:
    ...
    if args.hist:
        ...
        plt.plot(xgrid, hitDist(xgrid), '-b', linewidth=4, color='slategrey')
        ...
        plt.vlines(enrich, 0, ymax / 5.0, colors='slategrey')
        plt.axvline(x=effect, color='slategrey', ls='dashed', linewidth=2)
