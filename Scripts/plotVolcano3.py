...
if args.hist:
    ...
    plt.plot(x, y, '.', color='0', alpha=0.25, markersize=8, markeredgewidth=0)
...
if args.names:
    for name, gene in gene_labels:
        effect, rat = gene2effect_rat[gene]
        plt.plot(effect, rat, '.', color='red', markersize=20, markeredgewidth=0)
...
if args.thresh:
    ...
    plt.plot(x_thresh, y_thresh, '.', color='blue', markersize=10, markeredgewidth=0)
