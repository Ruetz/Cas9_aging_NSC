...
for gene, ref, effect in ref_list:
    ...
    if args.hist:
        ...
        plt.plot(xgrid, hitDist(xgrid), '-b', linewidth=4, color='limegreen')
        ...
        plt.vlines(enrich, 0, ymax / 5.0, colors='limegreen')
        plt.axvline(x=effect, color='limegreen', ls='dashed', linewidth=2)
