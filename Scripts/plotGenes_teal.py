...
for gene, ref, effect in ref_list:
    ...
    if args.hist:
        ...
        plt.plot(xgrid, hitDist(xgrid), '-b', linewidth=4, color='xkcd:pale teal')
        ...
        plt.vlines(enrich, 0, ymax / 5.0, colors='xkcd:pale teal')
        plt.axvline(x=effect, color='xkcd:pale teal', ls='dashed', linewidth=2)
