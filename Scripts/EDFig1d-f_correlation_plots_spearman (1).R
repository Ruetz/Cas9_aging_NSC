...
d14_y1_y2_score <- ggplot(d14_scores_from_supp1, aes(x = young1_direction_score_d14, y = young2_direction_score_d14)) +
  ...
  stat_cor(aes(label=..rr.label..), method = 'spearman', cor.coef.name = 'rho', label.x=70, label.y=78) +
...
d14_y2_y3_score <- ggplot(d14_scores_from_supp1, aes(x = young2_direction_score_d14, y = young3_direction_score_d14)) +
  geom_point(color = "black") +
  #geom_smooth(method = "lm", se = TRUE, level = 0.99) +
  stat_cor(aes(label=..rr.label..), method = 'spearman', cor.coef.name = 'rho', label.x=70, label.y=78) +
...
d14_y1_y3_score <- ggplot(d14_scores_from_supp1, aes(x = young1_direction_score_d14, y = young3_direction_score_d14)) +
  geom_point(color = "black") +
  #geom_smooth(method = "lm", se = TRUE, level = 0.99) +
  stat_cor(aes(label=..rr.label..), method = 'spearman', cor.coef.name = 'rho', label.x=70, label.y=78) +
  xlab("Young_rep1 casTLE Score") +
