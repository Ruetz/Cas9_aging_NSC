...
for gene, ref, effect in ref_list:
    ...
    if args.hist:
        ...
        plt.plot(xgrid, hitDist(xgrid), '-b', linewidth=4, color='xkcd:deep lavender')
        ...
        plt.vlines(enrich, 0, ymax / 5.0, colors='xkcd:deep lavender')
        plt.axvline(x=effect, color='xkcd:deep lavender', ls='dashed', linewidth=2)
