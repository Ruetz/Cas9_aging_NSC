...
for gene, ref, effect in ref_list:
    ...
    if args.hist:
        ...
        plt.plot(xgrid, hitDist(xgrid), '-b', linewidth=4, color='firebrick')
        ...
        plt.vlines(enrich, 0, ymax / 5.0, colors='xkcd:scarlet')
        plt.axvline(x=effect, color='xkcd:scarlet', ls='dashed', linewidth=2)
